...
image:express-direct-attach-aff220-deploy_image2.png["Un diagrama que compara las soluciones FlexPod Express, FlexPod Datacenter y FlexPod Select"]
...
image:express-direct-attach-aff220-deploy_image3.png["Un diagrama que muestra los servidores FlexPod Express, los conmutadores Nexus y el cableado de almacenamiento AFF para gestión, datos, IP, interconexión de clúster y redes homólogas vPC"]
