...
+
image:express-c-series-c190-deploy_image17.png["Una captura de pantalla de la página de la BIOS del servidor Cisco CIMC con el enlace Launch KVM en el menú superior"]
...
=== Descarga la imagen personalizada de Cisco para ESXi 6.7U2
...
+
image:express-c-series-c190-deploy_image18.png["Una captura de pantalla del instalador de ESXi en la que se selecciona un dispositivo de almacenamiento LUN de NETAPP C-Mode con una capacidad de 15,00 GiB"]
...
+
image:express-c-series-c190-deploy_image19.png["Una captura de pantalla de la ventana «Adaptadores de red» de ESXi con vmnic2 y vmnic4 seleccionados para la red de gestión"]
...
+
image:express-c-series-c190-deploy_image20.png["Una captura de pantalla de la página de redes de ESXi con la pestaña de conmutadores virtuales mostrando vSwitch0 y iScsiBootvSwitch"]
...
+
image:express-c-series-c190-deploy_image21.png["Una captura de pantalla de la configuración de agrupación y conmutación por error de iSCSIBootPG-A con vmnic3 activo y vmnic5 sin utilizar"]
...
+
image:express-c-series-c190-deploy_image22.png["Una captura de pantalla de la pestaña «Adaptadores de almacenamiento» de ESXi con el adaptador de software iSCSI vmhba64 seleccionado"]

. En Destinos dinámicos, haga clic en Agregar destino dinámico.
+
image:express-c-series-c190-deploy_image23.png["Una captura de pantalla que muestra destinos dinámicos iSCSI con cuatro direcciones IP y el puerto 3260 configurado"]
...
+
image:express-c-series-c190-deploy_image24.png["Una captura de pantalla de cuatro direcciones de destino dinámico iSCSI que utilizan el puerto 3260 y el botón Guardar configuración"]
...
. Seleccione vSwitch0.
+
image:express-c-series-c190-deploy_image25.png["Una captura de pantalla de la página vSwitch0 de ESXi en la que se muestra un MTU de 9000 y los adaptadores vmnic2 y vmnic4 activos"]
...
+
image:express-c-series-c190-deploy_image26.png["Una captura de pantalla de la página «Redes» de ESXi con la pestaña «Grupos de puertos» seleccionada y la opción «Add port group» disponible"]
...
+
image:express-c-series-c190-deploy_image27.png["Una captura de pantalla de la pestaña «VMkernel NICs» de red de ESXi, en la que aparecen las interfaces vmk0 y vmk1"]
...
+
image:express-c-series-c190-deploy_image28.png["Una captura de pantalla del cuadro de diálogo Añadir tarjeta de red VMkernel con la configuración IPv4 estática y vMotion seleccionada"]
...
+
image:express-c-series-c190-deploy_image29.png["Una captura de pantalla de la página «Almacenamiento» de VMware ESXi en la que se ve el botón «Nuevo almacén de datos»"]

. Seleccione Mount NFS Datastore.
+
image:express-c-series-c190-deploy_image30.png["Una captura de pantalla del asistente para crear un nuevo almacén de datos con la opción «Montar almacén de datos NFS» seleccionada como tipo de creación"]
...
. Haga clic en Guardar.
+
image:express-c-series-c190-deploy_image31.png["Una captura de pantalla que muestra la configuración de fecha y hora de ESXi con el servicio NTP en funcionamiento y tres servidores NTP"]
...
+
image:express-c-series-c190-deploy_image32.png["Una captura de pantalla de la página «Manage System Swap» de VMware ESXi, en la que se muestran los ajustes de intercambio"]

. Haga clic en Editar configuración. Seleccione `infra_swap` En las opciones del Datastore.
+
image:express-c-series-c190-deploy_image33.png["Una captura de pantalla del cuadro de diálogo Edit swap configuration con infra_swap seleccionado como datastore y los botones Save y Cancel"]
