...
+
image:express-c-series-c190-deploy_image49.png["Una captura de pantalla del cliente vSphere (Deploy OVF Template) con un archivo OVF de VSC seleccionado en el cuadro de diálogo Abrir"]
...
+
image:express-c-series-c190-deploy_image50.png["Una captura de pantalla del asistente «Implementar plantilla OVF» con el nombre de la máquina virtual FlexPod-VSC y FlexPod-Datacenter seleccionados"]

. Seleccione el clúster FlexPod-Cluster ESXi y haga clic en Next.
. Revise los detalles y haga clic en Next.
+
image:express-c-series-c190-deploy_image51.png["Una captura de pantalla que muestra el paso «Revisar detalles» para implementar la plantilla OVF del dispositivo virtual VSC de NetApp"]
...
+
image:express-c-series-c190-deploy_image52.png["Una captura de pantalla de la página «Seleccionar almacenamiento» de la plantilla «Deploy OVF Template», con Thin Provision y almacenes de datos NFS"]

. En Seleccionar redes, elija una red de destino y haga clic en Siguiente.
+
image:express-c-series-c190-deploy_image53.png["Una captura de pantalla del paso «Seleccionar redes» de la plantilla OVF, en el que se asigna nat a MGMT-Network"]
...
+
image:express-c-series-c190-deploy_image54.png["Una captura de pantalla de la página Personalizar plantilla de Implementar plantilla OVF, con los campos de registro de vCenter y Propiedades de red"]
...
+
image:express-c-series-c190-deploy_image55.png["Una consola de máquina virtual que muestra instrucciones para instalar VMware Tools antes de continuar con la instalación de VSC, VASA Provider y SRA"]
...
+
image:express-c-series-c190-deploy_image56.png["Una captura de pantalla del menú del vSphere Client con Virtual Storage Console resaltada"]
...
+
image:express-c-series-c190-deploy_image57.png["Una captura de pantalla de VSC NFS VAAI Tools con un archivo NetAppNasPlugin.vib seleccionado para su carga"]
...
+
image:express-c-series-c190-deploy_image58.png["Una captura de pantalla que muestra el menú VSC de NetApp con la opción Install NFS Plug-in for VMware VAAI seleccionada"]
...
+
image:express-c-series-c190-deploy_image59.png["Una captura de pantalla del menú Acciones del cliente vSphere con NetApp VSC establecer valores recomendados seleccionado"]
...
+
image:express-c-series-c190-deploy_image60.png["Un cuadro de diálogo «Valores recomendados» con los ajustes seleccionados para el adaptador HBA/CNA, MPIO y NFS"]

+
image:express-c-series-c190-deploy_image61.png["Después de detectar correctamente el sistema de almacenamiento, aparece un cuadro de diálogo de éxito que indica los ajustes modificados del host ESXi"]
