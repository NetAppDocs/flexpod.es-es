...
+
image:express-c-series-c190-deploy_image4.png["Una captura de pantalla de la configuración de OnCommand System Manager Support con los campos de AutoSupport y notificación de eventos"]
