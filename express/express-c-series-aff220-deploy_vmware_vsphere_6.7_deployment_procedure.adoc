...
+
image:express-c-series-aff220-deploy_image21.png["Una captura de pantalla de la página de la BIOS del servidor Cisco CIMC con el enlace Launch KVM en el menú superior"]
...
=== Descarga la imagen personalizada de ESXi 6.7 de Cisco

. Navega a la  https://support.broadcom.com/group/ecx/downloads["Sitio de descargas del portal de soporte de Broadcom"^] para ISOs personalizadas.
...
+
image:express-c-series-aff220-deploy_image22.png["Una captura de pantalla del instalador de ESXi en la que se selecciona un dispositivo de almacenamiento LUN de NETAPP C-Mode con una capacidad de 15,00 GiB"]
...
+
image:express-c-series-aff220-deploy_image23.png["Una captura de pantalla del menú «Adaptadores de red» de ESXi con vmnic0 y vmnic1 seleccionados para vSwitch0"]
...
+
image:express-c-series-aff220-deploy_image24.png["Una captura de pantalla de la pestaña «Conectores virtuales de red» de ESXi en la que se muestran vSwitch0 y iScsiBootvSwitch"]
...
** Haga clic en Crear.
+
image:express-c-series-aff220-deploy_image25.png["Una captura de pantalla del formulario «Añadir tarjeta de red VMkernel» en el que se configura iScsiBootPG-B con ajustes IPv4 estáticos y MTU 9000"]
...
+
image:express-c-series-aff220-deploy_image26.png["Una captura de pantalla de la página «Adaptadores de almacenamiento» de VMware ESXi con el adaptador de software iSCSI «vmhba64» seleccionado"]

. En Destinos dinámicos, haga clic en Agregar destino dinámico.
+
image:express-c-series-aff220-deploy_image27.png["Una captura de pantalla del cuadro de diálogo Configurar iSCSI con la opción Add dynamic target en la sección Dynamic targets"]
...
+
image:express-c-series-aff220-deploy_image28.png["Una captura de pantalla que muestra cuatro direcciones IP de destinos dinámicos iSCSI, cada una usando el puerto 3260"]
...
. Seleccione vSwitch0.
+
image:express-c-series-aff220-deploy_image29.png["Una captura de pantalla de la página vSwitch0 de VMware ESXi en la que se muestra un MTU de 1500 y dos adaptadores físicos activos"]
...
+
image:express-c-series-aff220-deploy_image30.png["Una captura de pantalla de la página «Redes» de ESXi con la pestaña «Grupos de puertos» seleccionada y la opción «Add port group» disponible"]
...
+
image:express-c-series-aff220-deploy_image31.png["Una captura de pantalla de la pestaña «NIC de VMkernel de red» de ESXi, en la que aparecen los adaptadores vmk0 y vmk1"]
...
** Haga clic en Crear.
+
image:express-c-series-aff220-deploy_image32.png["Una captura de pantalla del formulario «Add VMkernel NIC» en el que se configura el grupo de puertos «NFS-Network» con ajustes IPv4 estáticos"]
...
+
image:express-c-series-aff220-deploy_image33.png["Una captura de pantalla del cuadro de diálogo Añadir tarjeta de red VMkernel con la configuración IPv4 estática y vMotion seleccionada"]
...
+
image:express-c-series-aff220-deploy_image34.png["Una captura de pantalla de la página «Almacenamiento» de VMware ESXi en la que se ve el botón «Nuevo almacén de datos»"]

. Seleccione Mount NFS Datastore.
+
image:express-c-series-aff220-deploy_image35.png["Una captura de pantalla del asistente para crear un nuevo almacén de datos con la opción «Montar almacén de datos NFS» seleccionada como tipo de creación"]
...
+
image:express-c-series-aff220-deploy_image36.png["Una captura de pantalla de la página «Gestionar la hora y la fecha del sistema» de ESXi, en la que se muestra el estado del cliente NTP y los servidores NTP"]
...
+
image:express-c-series-aff220-deploy_image37.png["Una captura de pantalla del cuadro de diálogo «Configuración de la hora» con NTP activado y un servidor NTP introducido"]
...
+
image:express-c-series-aff220-deploy_image38.png["Una captura de pantalla de la página «Manage System Swap» de VMware ESXi, en la que se muestran los ajustes de intercambio"]

. Haga clic en Editar configuración. Seleccione infra_swap desde las opciones de Datastore.
+
image:express-c-series-aff220-deploy_image39.png["Una captura de pantalla del cuadro de diálogo Edit swap configuration con infra_swap seleccionado como datastore y los botones Save y Cancel"]
...
+
image:express-c-series-aff220-deploy_image40.png["Una ventana de terminal que muestra la instalación exitosa del VIB del complemento NFS de NetApp y un mensaje que indica que es necesario reiniciar"]
