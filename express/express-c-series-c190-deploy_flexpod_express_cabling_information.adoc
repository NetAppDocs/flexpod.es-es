...
image:express-c-series-c190-deploy_image3.png["Un diagrama que muestra las vistas traseras de dos conmutadores Nexus, dos servidores Cisco UCS y controladores AFF C190"]
