...
image:express-c-series-c190-deploy_image1.png["Un diagrama que muestra las opciones del portafolio de FlexPod Express y FlexPod Datacenter con casos de uso"]
...
image:express-c-series-c190-deploy_image2.png["Un diagrama que muestra los conmutadores Express de FlexPod, los servidores C220 M5 y las conexiones de almacenamiento AFF C190"]
