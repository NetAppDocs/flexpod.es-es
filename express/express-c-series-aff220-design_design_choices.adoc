...
Para obtener más información sobre el sistema de hardware AFF A220, consulta https://www.netapp.com/aff-a-series/["Página de inicio De AFF a-Series"^].
...
image:express-c-series-aff220-design_image5.png["Un diagrama que muestra varios bloques lógicos de 4 KB compactados en un único bloque físico de 4 KB"]
...
image:express-c-series-aff220-design_image6.png["Un diagrama que muestra los discos divididos en las particiones root, Controller 1 y Controller 2"]

Estas son solo algunas funciones clave que complementan la solución FlexPod Express. Para detalles sobre las funciones y la funcionalidad adicionales de ONTAP 9.4, consulta el https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf["Especificaciones técnicas del software de gestión de datos ONTAP 9"^]. También consulta el NetApp http://docs.netapp.com/ontap-9/index.jsp["Centro de documentación de ONTAP 9"^], que se ha actualizado para incluir ONTAP 9.4.
...
image:express-c-series-aff220-design_image7.png["Una captura de pantalla que muestra la vista frontal de un conmutador Cisco Nexus 3172 con puertos de red"]
...
image:express-c-series-aff220-design_image8.png["Vista frontal de un servidor en rack Cisco UCS C220 M5 con dos bahías para unidades y el logotipo de Cisco"]
...
image:express-c-series-aff220-design_image9.png["Una tarjeta adaptadora Cisco UCS VIC 1387 con dos puertos QSFP+ y un ventilador de refrigeración"]
...
image:express-c-series-aff220-design_image10.png["Una fotografía de un módulo adaptador Cisco CVR-QSFP-SFP10G QSFP a SFP"]
