...
+
image:express-c-series-aff220-deploy_image6.png["Una captura de pantalla de los campos de configuración de clúster de la configuración guiada de System Manager para dos nodos en un par de alta disponibilidad y licencias"]
...
+
image:express-c-series-aff220-deploy_image7.png["Una captura de pantalla de la configuración de OnCommand System Manager Support con los campos de AutoSupport y notificación de eventos"]
