...
image:express-c-series-aff220-design_image3.png["Un diagrama que muestra las familias de hardware de almacenamiento, conmutación y procesamiento de FlexPod Express con opciones de configuración"]
...
image:express-c-series-aff220-design_image4.png["Un diagrama que muestra los conmutadores Cisco Nexus 3172P, los servidores UCS C220 M5 y la conectividad de almacenamiento AFF A220"]
