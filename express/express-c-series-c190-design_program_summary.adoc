...
image:express-c-series-c190-design_image1.png["Un diagrama que compara las implementaciones departamentales de FlexPod Express con las cargas de trabajo críticas de FlexPod Datacenter"]
...
image:express-c-series-c190-design_image2.png["Un diagrama que muestra las opciones de hardware de almacenamiento, switch y servidor de FlexPod Express"]
...
image:express-c-series-c190-design_image3.png["Un diagrama que muestra los conmutadores Express de FlexPod, los servidores C220 M5 y las conexiones de almacenamiento AFF C190"]
