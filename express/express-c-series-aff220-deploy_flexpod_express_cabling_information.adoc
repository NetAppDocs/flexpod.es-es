...
image:express-c-series-aff220-deploy_image5.png["Un diagrama en el que se muestran los conmutadores Cisco Nexus, los servidores Cisco UCS y los controladores AFF A220 de NetApp con puertos de 10 GbE resaltados"]
