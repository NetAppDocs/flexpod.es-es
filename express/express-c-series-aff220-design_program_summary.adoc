...
image:express-c-series-aff220-design_image2.png["Un diagrama que muestra FlexPod Express, Datacenter y Select, con las implementaciones objetivo y los componentes"]
