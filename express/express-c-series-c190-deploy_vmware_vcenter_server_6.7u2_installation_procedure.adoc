...
+
image:express-c-series-c190-deploy_image34.png["Una captura de pantalla de la página del vCenter Server Appliance Installer End User License Agreement con la aceptación seleccionada"]
...
+
image:express-c-series-c190-deploy_image35.png["Una captura de pantalla de la página de tipos de instalación del instalador del vCenter Server Appliance con la opción Embedded Platform Services Controller seleccionada"]
...
+
image:express-c-series-c190-deploy_image36.png["Una captura de pantalla del formulario de destino de implementación del instalador de vCenter Server Appliance con las credenciales del host ESXi"]
...
+
image:express-c-series-c190-deploy_image37.png["Una captura de pantalla de la página de configuración de la máquina virtual del instalador de vCenter Server Appliance, con los campos de nombre de la máquina virtual y contraseña de root"]

. Seleccione el tamaño de puesta en marcha que mejor se adapte a su entorno. Haga clic en Siguiente.
+
image:express-c-series-c190-deploy_image38.png["Una captura de pantalla de la página Select deployment size del instalador de vCenter Server Appliance, con Tiny seleccionado"]
...
+
image:express-c-series-c190-deploy_image39.png["Una captura de pantalla de la página Configure network settings del instalador de vCenter Server Appliance, con MGMT-Network seleccionado"]

. Revise la configuración en la etapa 1 antes de iniciar la implementación del dispositivo.
+
image:express-c-series-c190-deploy_image40.png["Una captura de pantalla de la página de revisión de la configuración lista para completar la etapa 1 del instalador de vCenter Server Appliance"]
...
+
image:express-c-series-c190-deploy_image41.png["Una captura de pantalla de la página de introducción de la fase 2 del instalador del vCenter Server Appliance, con un botón Next"]
...
+
image:express-c-series-c190-deploy_image42.png["Captura de pantalla de la fase 2 de la configuración de SSO en el instalador de vCenter Server Appliance, con un nuevo dominio de SSO seleccionado"]
...
+
image:express-c-series-c190-deploy_image43.png["Una captura de pantalla de la página Configure CEIP del instalador del vCenter Server Appliance, con la opción CEIP seleccionada"]
...
+
image:express-c-series-c190-deploy_image44.png["Una captura de pantalla del instalador de vCenter Server Appliance en la que se advierte que la instalación no se puede pausar ni detener, con los botones Cancelar y OK"]
