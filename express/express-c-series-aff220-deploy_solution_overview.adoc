...
image:express-c-series-aff220-deploy_image3.png["Un diagrama que compara FlexPod Express, Datacenter y Select, sus soluciones, objetivos y componentes de infraestructura"]
...
image:express-c-series-aff220-deploy_image4.png["Un diagrama que muestra los conmutadores Cisco Nexus 3172P, los servidores UCS C220 M5 y la conectividad de almacenamiento AFF A220"]
