...
+
image:express-c-series-aff220-deploy_image49.png["Una captura de pantalla del cuadro de diálogo Nuevo clúster con DRS y vSphere HA habilitados para el clúster Tiger3"]
...
+
image:express-c-series-aff220-deploy_image50.png["Una captura de pantalla del vSphere Web Client que muestra el menú Actions del clúster FlexPod con Add Host seleccionado"]
