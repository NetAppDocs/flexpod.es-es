...
+
image:express-c-series-aff220-deploy_image41.png["Una captura de pantalla de la página Host de VMware ESXi con el botón Obtener servidor vCenter resaltado"]
...
+
image:express-c-series-aff220-deploy_image42.png["Una captura de pantalla de la selección del tipo de implementación del vCenter Server Appliance con Embedded Platform Services Controller seleccionado"]
...
+
image:express-c-series-aff220-deploy_image43.png["Una captura de pantalla de la página de destino de implementación del dispositivo vCenter Server con los campos de host ESXi, puerto, usuario raíz y contraseña"]
...
+
image:express-c-series-aff220-deploy_image44.png["Una captura de pantalla de la página «Configurar la máquina virtual del dispositivo» con los campos de nombre de la máquina virtual y contraseña de root"]

. Seleccione el tamaño de puesta en marcha que mejor se adapte a su entorno. Haga clic en Siguiente.
+
image:express-c-series-aff220-deploy_image45.png["Una captura de pantalla de la página de tamaño de la implementación del servidor vCenter con las opciones de almacenamiento Tiny y Default seleccionadas"]

. Seleccione el almacén de datos de infra_datastore_1. Haga clic en Siguiente.
+
image:express-c-series-aff220-deploy_image46.png["Captura de pantalla de la página «Seleccionar almacén de datos» del instalador de vCenter Server con infra_datastore_1 seleccionado"]
...
+
image:express-c-series-aff220-deploy_image47.png["Captura de pantalla del instalador de vCenter Server Appliance configurando los parámetros de red con los campos de IPv4 estática rellenados"]
...
+
image:express-c-series-aff220-deploy_image48.png["Una captura de pantalla de la página de introducción de la fase 2 del vCenter Server Appliance con un botón Next"]
