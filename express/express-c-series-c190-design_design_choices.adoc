...
image:express-c-series-c190-design_image4.png["Un diagrama que muestra las vistas traseras de dos controladores AFF C190 con puertos UTA 2 para módulos SFP+"]
...
image:express-c-series-c190-design_image5.png["Un esquema que muestra el panel trasero de un sistema AFF C190 con puertos RJ-45 10GBASE-T"]
...
Para obtener información completa sobre el sistema de hardware AFF C190, consulta https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp documentación de AFF C190"^].
...
image:express-c-series-c190-design_image6.png["Un diagrama que muestra varios bloques lógicos de 4 KB compactados en un único bloque físico de 4 KB"]
...
image:express-c-series-c190-design_image7.png["Vista frontal de un conmutador Cisco Nexus 31108PC-V con 48 puertos SFP+ y seis puertos QSFP28"]
...
image:express-c-series-c190-design_image8.png["Vista frontal de un servidor en rack Cisco UCS C220 M5 con dos bahías para unidades y el logotipo de Cisco"]
...
image:express-c-series-c190-design_image9.png["Una captura de pantalla del adaptador Cisco UCS VIC 1457 con cuatro puertos SFP28 y un ventilador de refrigeración"]
...
image:express-c-series-c190-design_image10.png["Un diagrama que muestra cuatro vNIC conectadas a FlexPod y vSwitches de arranque iSCSI en un host VMware ESXi 6.7 U2"]
