...
Sigue los procedimientos de instalación física de los controladores en el https://docs.netapp.com/us-en/ontap-systems/a220/install-setup.html["Documentación de AFF A220"^].
...
+
image:express-direct-attach-aff220-deploy_image7.png["Una captura de pantalla del cuadro de diálogo «Crear bloque de direcciones IPv4» con los campos de dirección IP, subred, puerta de enlace y DNS"]
...
+
image:express-direct-attach-aff220-deploy_image8.png["Una captura de pantalla del cuadro de diálogo «Add NTP Server» con NTP Server establecido en 10.1.156.4"]

. Haga clic en Add NTP Server.
. Introduzca `<switch-b-ntp-ip>` `or <Nexus-B-mgmt-IP>` Y haga clic en Aceptar. Haga clic en Aceptar en la confirmación.
+
image:express-direct-attach-aff220-deploy_image9.png["Una captura de pantalla de la configuración de NTP de Cisco UCS Manager con dos servidores NTP listados y la zona horaria America/New_York seleccionada"]
...
+
image:express-direct-attach-aff220-deploy_image10.png["Una captura de pantalla que muestra los puertos Ethernet de Fabric Interconnect A con los roles de enlace ascendente y almacenamiento de dispositivos configurados"]
...
. En la pestaña puertos Ethernet, confirme que los puertos se han configurado correctamente en la columna If Role. Si se han configurado servidores C-Series de puertos en el puerto de escalabilidad, haga clic en él para verificar la conectividad de los puertos.
+
image:express-direct-attach-aff220-deploy_image11.png["Una captura de pantalla que muestra los puertos Ethernet de Fabric Interconnect B con las funciones de red y de almacenamiento de dispositivos configuradas"]
...
+
image:express-direct-attach-aff220-deploy_image12.png["Una captura de pantalla del cuadro de diálogo Create Port Channel con el ID 1 y el nombre vPC-13-Nexus introducidos"]
...
+
image:express-direct-attach-aff220-deploy_image13.jpeg["Una captura de pantalla del cuadro de diálogo «Crear VLAN» con «NFS-VLAN» y el ID de VLAN 3170 introducidos"]
...
. Haga clic en OK y, a continuación, vuelva a hacer clic en OK para crear la VLAN.
+
image:express-direct-attach-aff220-deploy_image14.png["Una captura de pantalla que muestra la tabla de VLANs en Cisco UCS Manager con los nombres y los ID de las VLANs"]
...
+
image:express-direct-attach-aff220-deploy_image15.png["Una captura de pantalla que muestra la política de control de red Enable_CDP con CDP y LLDP habilitados para transmitir y recibir"]
...
+
image:express-direct-attach-aff220-deploy_image16.png["Una captura de pantalla de las propiedades de Appliance Interface 1/3 con CDP activado y las VLAN de almacenamiento seleccionadas"]
...
+
image:express-direct-attach-aff220-deploy_image17.png["Captura de pantalla de la configuración de VLAN de Appliance Interface 1/3, con iSCSI-B, NFS y VLAN nativas seleccionadas"]
...
+
image:express-direct-attach-aff220-deploy_image18.png["Una captura de pantalla de la configuración de System Class de QoS en Cisco UCS Manager, con el valor de MTU de Best Effort establecido en 9216"]
...
+
image:express-direct-attach-aff220-deploy_image19.png["Una captura de pantalla del cuadro de diálogo «Modificar versiones del paquete» con Blade Package 4.0(1b)B seleccionado"]
...
+
image:express-direct-attach-aff220-deploy_image20.png["Una captura de pantalla del cuadro de diálogo «Crear un bloque de direcciones MAC» con la dirección MAC 00:25:B5:32:0A:00 y un tamaño de 64"]
...
+
image:express-direct-attach-aff220-deploy_image21.png["Una captura de pantalla del cuadro de diálogo Create a Block of IQN Suffixes con el sufijo ucs-host, From 1 y Size 16"]
...
+
image:express-direct-attach-aff220-deploy_image22.png["Una captura de pantalla del cuadro de diálogo «Crear política de control de red» con CDP y LLDP activados"]
...
+
image:express-direct-attach-aff220-deploy_image23.png["Una captura de pantalla del cuadro de diálogo «Crear Power Control Policy» con No-Power-Cap y No Cap seleccionados"]
...
+
image:express-direct-attach-aff220-deploy_image24.png["Una captura de pantalla del cuadro de diálogo Crear requisitos de CPU/núcleos de Cisco UCS Manager, con la arquitectura del procesador Xeon y el campo CPU PID"]
...
+
image:express-direct-attach-aff220-deploy_image25.png["Una captura de pantalla del cuadro de diálogo Create BIOS Policy con el nombre de VM-Host y la opción Consistent Device Naming activada"]
...
+
image:express-direct-attach-aff220-deploy_image26.png["Una captura de pantalla de la pestaña «Create BIOS Policy Processor» con las opciones «Processor C State» y «C1E» desactivadas"]
...
+
image:express-direct-attach-aff220-deploy_image27.png["Una captura de pantalla que muestra las opciones del procesador en la BIOS, con Energy Performance y DRAM Clock Throttling configurados en rendimiento."]
...
+
image:express-direct-attach-aff220-deploy_image28.png["Una captura de pantalla de la página Create BIOS Policy RAS Memory, con el modo LV DDR configurado en Performance Mode"]
...
+
image:express-direct-attach-aff220-deploy_image29.png["Una captura de pantalla de la política de mantenimiento predeterminada de Cisco UCS Manager con las opciones «User Ack» y «On Next Boot» seleccionadas"]
...
. Haga clic en Aceptar.
+
image:express-direct-attach-aff220-deploy_image30.png["Captura de pantalla de las propiedades de la plantilla de vNIC de Cisco UCS Manager para vNIC_Template_A en Fabric A"]
...
. Haga clic en Aceptar.
+
image:express-direct-attach-aff220-deploy_image31.png["Captura de pantalla de la configuración de la plantilla vNIC B de Cisco UCS Manager, con Fabric B, MTU 9000 y el grupo MAC B seleccionados"]
...
. Haga clic en Aceptar.
+
image:express-direct-attach-aff220-deploy_image32.png["Una captura de pantalla de la plantilla de vNIC Site_01_iSCSI-A con Fabric A, MTU 9000 y el grupo MAC A56/64 seleccionados"]
...
. Haga clic en Aceptar.
+
image:express-direct-attach-aff220-deploy_image33.png["Captura de pantalla de la configuración de la plantilla de vNIC Site_01_iSCSI-B de Cisco UCS Manager para Fabric B con MTU 9000"]
...
+
image:express-direct-attach-aff220-deploy_image34.png["Una captura de pantalla que muestra el cuadro de diálogo «Modificar vNIC» para Site-01-vNIC-A usando vNIC_Template_A y la política del adaptador VMWare"]
...
+
image:express-direct-attach-aff220-deploy_image35.png["Una captura de pantalla del cuadro de diálogo «Modificar vNIC iSCSI» para Site-01-iSCSI-A con la configuración de VLAN y dirección MAC"]
...
. Haga clic en Save Changes.
+
image:express-direct-attach-aff220-deploy_image36.png["Una captura de pantalla de la política de conectividad LAN Site-01-iSCSIBoot con dos vNIC iSCSI enumeradas"]
...
+
Esta imagen ISO de VMware ESXi 6.7U1 se puede descargar desde https://support.broadcom.com/group/ecx/downloads["Portal de soporte de Broadcom"^].
...
+
image:express-direct-attach-aff220-deploy_image37.png["Una captura de pantalla del cuadro de diálogo Crear vMedia Mount configurado con un archivo ISO del instalador de ESXi por HTTP y la ruta correspondiente"]
...
+
image:express-direct-attach-aff220-deploy_image38.png["Una captura de pantalla de la política de arranque Site-01-Fabric-A de Cisco UCS Manager con dos entradas de arranque iSCSI configuradas"]
...
+
image:express-direct-attach-aff220-deploy_image39.png["Una captura de pantalla del asistente «Crear plantilla de perfil de servicio» con los campos nombre, actualización de la plantilla y conjunto de UUID"]
...
+
image:express-direct-attach-aff220-deploy_image40.png["Captura de pantalla de la configuración de red de la plantilla «Crear perfil de servicio» con conectividad iSCSI-Boot y la opción «IQN_Pool» seleccionada"]
...
+
image:express-direct-attach-aff220-deploy_image41.png["Una captura de pantalla de la página «Crear plantilla de perfil de servicio: orden de arranque del servidor» con la opción «Boot-Fabric-A» seleccionada"]
...
+
image:express-direct-attach-aff220-deploy_image42.png["Una captura de pantalla de la salida del comando iscsi show que muestra el IQN de destino Infra-SVM, el alias y el estado up"]

. Introduzca la dirección IP de `iscsi_lif_02a` Para el campo Dirección IPv4.
+
image:express-direct-attach-aff220-deploy_image43.png["Una captura de pantalla del cuadro de diálogo «Crear destino iSCSI estático» con la dirección IPv4 192.168.10.62 introducida"]
...
+
image:express-direct-attach-aff220-deploy_image44.png["Una captura de pantalla del cuadro de diálogo «Crear destino iSCSI estático» con la dirección IPv4 192.168.10.61 y el ID de LUN 0"]

. Haga clic en OK para añadir el destino estático iSCSI.
+
image:express-direct-attach-aff220-deploy_image45.png["Una captura de pantalla del cuadro de diálogo «Configurar parámetros de arranque iSCSI» con las interfaces de destino iSCSI estáticas seleccionadas"]
...
+
image:express-direct-attach-aff220-deploy_image46.png["Una captura de pantalla del cuadro de diálogo «Crear destino iSCSI estático» con la dirección IPv4 establecida en 192.168.20.62"]
...
+
image:express-direct-attach-aff220-deploy_image47.png["Una captura de pantalla del cuadro de diálogo «Crear destino iSCSI estático» con la dirección IPv4 192.168.20.61 y el ID de LUN 0"]

. Haga clic en OK para añadir el destino estático iSCSI.
+
image:express-direct-attach-aff220-deploy_image48.png["Una captura de pantalla en la que se ven seleccionadas dos interfaces de destino iSCSI estáticas en la opción «Configurar parámetros de arranque iSCSI»"]
...
+
image:express-direct-attach-aff220-deploy_image49.png["Una captura de pantalla del paso «Crear plantilla de perfil de servicio de política de mantenimiento» con la política predeterminada seleccionada"]
...
+
image:express-direct-attach-aff220-deploy_image50.png["Una captura de pantalla de la opción «Crear asignación de servidor de plantilla de perfil de servicio» con «Infra-Pool», el estado de alimentación «Apagado» y el paquete de firmware predeterminado seleccionados"]
...
+
image:express-direct-attach-aff220-deploy_image51.png["Una captura de pantalla de la página Create Service Profile Template Operational Policies con VM-Host BIOS y No-Power-Cap seleccionados"]
...
+
image:express-direct-attach-aff220-deploy_image52.png["Una captura de pantalla del cuadro de diálogo «Create Service Profiles From Template» con el prefijo Site-01-Infra-0, el número 2 y la organización raíz"]
...
. Inicia sesión en el portal de soporte de Broadcom download site: https://support.broadcom.com/group/ecx/downloads["https://support.broadcom.com/group/ecx/downloads"^].
. Necesitarás un nombre de usuario y una contraseña de Broadcom. Busca VMware vSphere Hypervisor (ESXi) Custom ISOs.
. Descarga la imagen personalizada de Cisco para el CD de instalación de ESXi 6.7U1.
...
. Pulse Intro.
+
image:express-direct-attach-aff220-deploy_image53.png["Una captura de pantalla de la ventana «Adaptadores de red» de ESXi con vmnic0 y vmnic1 seleccionados y conectados"]
...
+
image:express-direct-attach-aff220-deploy_image54.png["Una captura de pantalla que muestra los detalles y la topología de vSwitch0 con adaptadores VMkernel y dos adaptadores físicos"]
...
+
image:express-direct-attach-aff220-deploy_image55.png["Una captura de pantalla de la pestaña «NIC de VMkernel» de ESXi, en la que aparecen cinco adaptadores VMkernel y sus grupos de puertos"]
...
+
image:express-direct-attach-aff220-deploy_image56.png["Una captura de pantalla de la pestaña «Adaptadores de almacenamiento» de ESXi con el adaptador de software iSCSI vmhba64 seleccionado"]
...
+
image:express-direct-attach-aff220-deploy_image57.png["Una captura de pantalla del cuadro de diálogo «Configurar iSCSI» que muestra cuatro destinos iSCSI dinámicos y estáticos en el puerto 3260"]
...
+
image:express-direct-attach-aff220-deploy_image58.png["Una captura de pantalla del asistente para crear un nuevo almacén de datos con la opción «Montar almacén de datos NFS» seleccionada como tipo de creación"]
...
.. Haga clic en Siguiente.
+
image:express-direct-attach-aff220-deploy_image59.png["Una captura de pantalla de la página «Proporcionar detalles de montaje NFS» con «infra_datastore_1» y el servidor NFS 192.168.104.3"]
...
. Haga clic en Finalizar. El almacén de datos ahora debe aparecer en la lista de almacenes de datos.
+
image:express-direct-attach-aff220-deploy_image60.jpeg["Una captura de pantalla de la lista de almacenes de datos de ESXi en la que se muestra infra_datastore_2 montado como un almacén de datos NFS"]
...
+
image:express-direct-attach-aff220-deploy_image61.png["Una captura de pantalla del cuadro de diálogo «Configuración de la hora» con NTP activado y dos direcciones de servidor NTP introducidas"]
...
+
image:express-direct-attach-aff220-deploy_image62.png["Una captura de pantalla de la página Manage System Swap de VMware ESXi que muestra la configuración de intercambio y la opción Edit settings"]

. Haga clic en Editar configuración. Seleccione `infra_swap` En las opciones del Datastore.
+
image:express-direct-attach-aff220-deploy_image63.png["Una captura de pantalla del cuadro de diálogo «Editar configuración de intercambio» con el almacén de datos «infra_swap» seleccionado y los botones «Guardar» y «Cancelar»"]
...
+
image:express-direct-attach-aff220-deploy_image64.png["Una captura de pantalla del navegador del host ESXi con el botón Obtener servidor vCenter resaltado"]
...
+
image:express-direct-attach-aff220-deploy_image65.png["Una captura de pantalla de la página Select deployment type del instalador de vCenter Server Appliance, con Embedded Platform Services Controller seleccionado"]
...
+
image:express-direct-attach-aff220-deploy_image66.png["Una captura de pantalla de la página de destino de implementación del instalador de VCenter Server Appliance con las credenciales del host ESXi introducidas"]
...
+
image:express-direct-attach-aff220-deploy_image67.png["Una captura de pantalla de la página de configuración de la máquina virtual del instalador de vCenter Server Appliance, con los campos de nombre de la máquina virtual y contraseña de root"]

. Seleccione el tamaño de puesta en marcha que mejor se adapte a su entorno. Haga clic en Siguiente.
+
image:express-direct-attach-aff220-deploy_image68.png["Una captura de pantalla de la página Select deployment size del instalador de vCenter Server Appliance, con Tiny seleccionado"]

. Seleccione la `infra_datastore_1` almacén de datos. Haga clic en Siguiente.
+
image:express-direct-attach-aff220-deploy_image69.png["Una captura de pantalla de la página Select datastore del instalador de vCenter Server Appliance, con infra_datastore_1 listado entre tres almacenes de datos"]
...
+
image:express-direct-attach-aff220-deploy_image70.png["Una captura de pantalla de la página «Configurar los ajustes de red» del instalador de vCenter Server Appliance con los detalles de IPv4 estáticos"]
...
+
image:express-direct-attach-aff220-deploy_image71.png["Una captura de pantalla que muestra la implementación correcta de la Etapa 1 del servidor vCenter con un botón Continuar"]
...
. Haga clic en Aceptar.
+
image:express-direct-attach-aff220-deploy_image72.png["Una captura de pantalla del cuadro de diálogo Nuevo clúster con DRS y vSphere HA habilitados para el clúster Express"]
...
+
image:express-direct-attach-aff220-deploy_image73.png["Una captura de pantalla del menú Acciones del vSphere Client para el clúster Express con la opción Add Hosts seleccionada"]
