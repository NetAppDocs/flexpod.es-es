...
+
image:express-c-series-c190-deploy_image5.png["Una captura de pantalla que muestra la pantalla de arranque de un servidor Cisco en la que se solicita a los usuarios que pulsen F8 para la configuración de CIMC"]
...
+
image:express-c-series-c190-deploy_image6.png["Captura de pantalla de Cisco IMC Configuration Utility NIC Properties con una NIC dedicada y sin redundancia seleccionada"]
...
+
image:express-c-series-c190-deploy_image7.png["Una captura de pantalla de la página «Configurar el orden de arranque» del BIOS del Cisco Integrated Management Controller"]
...
+
image:express-c-series-c190-deploy_image8.png["Una captura de pantalla de la configuración avanzada del orden de arranque con KVM-MAPPED-DVD, iSCSI-A e iSCSI-B activados"]
...
+
image:express-c-series-c190-deploy_image9.png["Una captura de pantalla que muestra la configuración de la BIOS de CIMC con las Option ROM de las ranuras PCIe 1 y 2 desactivadas"]
...
+
image:express-c-series-c190-deploy_image10.png["Una captura de pantalla de la pestaña General de la tarjeta adaptadora Cisco Integrated Management Controller MLOM, con Port Channel desmarcado"]
...
+
image:express-c-series-c190-deploy_image11.png["Una captura de pantalla que muestra la configuración general de la vNIC iSCSI eth1 con la VLAN 3439 y el puerto de enlace ascendente 1"]



. Seleccione el eth1 de VNIC a la izquierda.
+
image:express-c-series-c190-deploy_image12.png["Una captura de pantalla que muestra la configuración del iniciador en las Propiedades de arranque iSCSI para la vNIC eth1"]
...
+
image:express-c-series-c190-deploy_image13.png["Una captura de pantalla de las propiedades de arranque de iSCSI con los detalles del iniciador, el destino principal y el destino secundario"]
...
+
image:express-c-series-c190-deploy_image14.png["Una captura de pantalla que muestra las propiedades de arranque iSCSI para la vNIC eth3 con la configuración del iniciador y del destino"]
...
+
image:express-c-series-c190-deploy_image15.png["Una captura de pantalla de las propiedades de la vNIC eth0 de Cisco Integrated Management Controller con un MTU de 9000 y la VLAN predeterminada 2"]

. Repita los pasos 3 y 4 en eth1, verificando que el puerto de enlace ascendente se establece en 1 para eth1.
+
image:express-c-series-c190-deploy_image16.png["Una captura de pantalla de las vNIC del Cisco Integrated Management Controller, en la que aparecen eth0 a eth3 con la configuración de MTU, puerto de enlace ascendente y VLAN"]
