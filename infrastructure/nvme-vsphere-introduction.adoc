...
En colaboración con: image:cisco logo.png[""]
...
image:nvme-vsphere-image1.png["Un diagrama que muestra el almacenamiento, el switch y las familias de componentes de Cisco UCS de FlexPod con las series de productos compatibles"]
