...
image:cloud-fabricpool_image8.png["Una captura de pantalla del cuadro de diálogo «Add License Packages» de OnCommand System Manager, con los botones «Choose Files» y «Add»"]
...
image:cloud-fabricpool_image9.png["Una captura de pantalla de los detalles de las licencias de ONTAP System Manager que muestra una capacidad de licencia de FabricPool de 10 TB y una capacidad actual de 0 Byte"]
