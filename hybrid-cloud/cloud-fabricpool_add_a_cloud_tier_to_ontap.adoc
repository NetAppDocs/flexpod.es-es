...
image:cloud-fabricpool_image13.png["Una captura de pantalla del formulario «Add Cloud Tier» configurado para un proveedor de nivel en la nube de Amazon S3"]
