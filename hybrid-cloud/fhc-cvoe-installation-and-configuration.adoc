...
Para implementar la instancia local de FlexPod, consulta https://www.cisco.com/c/en/us/td/docs/unified_computing/ucs/UCS_CVDs/flexpod_xseries_vmware_7u2.html["esta guía de implementación"^].
