...
Para obtener más información sobre las licencias de Intersight y las funciones incluidas en cada tipo de licencia, consulta https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["aquí"^].
...
Una vez que hayas registrado Intersight Assist en Intersight, puedes registrar dispositivos endpoint usando la opción «Registrar a través de Intersight Assist». Para más información, consulta https://intersight.com/help/saas/getting_started/overview["Primeros pasos"^].
