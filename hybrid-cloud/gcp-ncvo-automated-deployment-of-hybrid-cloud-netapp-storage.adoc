...
https://github.com/ucs-compute-solutions/cvo_snapmirror["Este enlace de GitHub"^] proporciona la configuración de Terraform con diversos recursos. Puedes hacer un fork de este repositorio y crear una copia en tu cuenta de GitHub.
