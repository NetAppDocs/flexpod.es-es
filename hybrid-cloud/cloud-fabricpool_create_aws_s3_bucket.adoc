...
image:cloud-fabricpool_image10.png["Un diagrama que muestra las configuraciones válidas e inválidas de asignación de agregados a buckets en FabricPool"]
...
+
image:cloud-fabricpool_image11.png["Una captura de pantalla de la búsqueda en la consola de AWS en la que aparece resaltado el resultado «S3 Scalable Storage in the Cloud»"]
...
+
image:cloud-fabricpool_image12.png["Una captura de pantalla del cuadro de diálogo «Create bucket» de AWS, con el nombre del bucket, la región y el botón Create"]
