...
+
image:cloud-fabricpool_image14.png["Una captura de pantalla que muestra el menú de navegación de OnCommand System Manager con la opción «Aplicaciones y niveles» seleccionada"]

. Haga clic en Storage Tiers.
. Haga clic en un agregado.
. Haga clic en Actions y seleccione Attach Cloud Tier.
+
image:cloud-fabricpool_image15.png["Una captura de pantalla que muestra el menú Más acciones con la opción Adjuntar nivel de la nube seleccionada"]
