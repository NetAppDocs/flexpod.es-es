...
image:cloud-fabricpool_image2.png["Un diagrama que muestra el almacenamiento FlexPod, los conmutadores Cisco Nexus y MDS, y las familias Cisco UCS con orientación sobre la conectividad"]
...
image:cloud-fabricpool_image3.png["Un diagrama que muestra las conexiones de Cisco UCS, Nexus 93180YC-EX, AFF A300 y MDS 9148S"]
