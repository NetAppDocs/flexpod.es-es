...
image:cloud-fabricpool_image4.png["Un diagrama que muestra el traslado de copias de instantáneas mediante la organización en niveles Snapshot-Only desde un clúster primario al almacenamiento en la nube"]
...
image:cloud-fabricpool_image5.png["Un diagrama que muestra cómo la organización automática por niveles traslada los datos inactivos del almacenamiento del clúster principal al almacenamiento en la nube"]
