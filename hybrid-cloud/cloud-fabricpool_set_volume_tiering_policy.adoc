...
+
image:cloud-fabricpool_image16.png["Una captura de pantalla que muestra el cuadro de diálogo Cambiar política de organización por niveles de volumen, con las opciones de la política de organización por niveles expandidas"]
