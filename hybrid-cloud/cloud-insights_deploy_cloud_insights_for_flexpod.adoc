...
. Ir a https://www.netapp.com/data-infrastructure-insights/["https://www.netapp.com/data-infrastructure-insights/"^]
...
+
image:cloud-insights_image3.png["Un menú contextual de vSphere con la opción Nueva máquina virtual resaltada entre las acciones del clúster"]
...
+
image:cloud-insights_image4.png["Una captura de pantalla del asistente «Seleccionar un sistema operativo invitado» con Linux y Red Hat Enterprise Linux 7 (64-bit) seleccionados"]
...
+
image:cloud-insights_image5.png["Captura de pantalla de la configuración de hardware personalizada de VMware, con CPU, memoria, disco, red y unidad de CD/DVD configurados"]
...
+
image:cloud-insights_image6.png["Una captura de pantalla del menú de arranque de Red Hat Enterprise Linux 7.6 con la opción «Instalar» seleccionada"]
...
+
image:cloud-insights_image7.png["Una captura de pantalla en la que se muestra un disco virtual de VMware de 100 GiB seleccionado y la opción de particionamiento manual"]
...
+
image:cloud-insights_image8.png["Una captura de pantalla del particionamiento manual en Red Hat Enterprise Linux con volúmenes de 25 GiB en /opt/netapp y /var/log/netapp"]
...
+
image:cloud-insights_image9.png["Una captura de pantalla de la ventana Red Hat Enterprise Linux Network  Host Name con Ethernet activada y un nombre de host introducido"]
...
+
image:cloud-insights_image10.png["Una captura de pantalla de la pantalla de finalización de la instalación de Red Hat Enterprise Linux con un botón \"Reiniciar\""]

. Una vez reiniciado el sistema, inicie sesión en el servidor y regístrelo con Red Hat Subscription Manager.
+
image:cloud-insights_image11.png["Una ventana de terminal que muestra el registro exitoso en Red Hat Subscription Manager para el sistema NetApp-AU"]

. Adjunte una suscripción disponible a Red Hat Enterprise Linux.
+
image:cloud-insights_image12.png["Una terminal que muestra la activación exitosa de una suscripción a Red Hat Enterprise Linux"]
...
+
image:cloud-insights_image14.png["Una captura de pantalla que muestra las pestañas «Data Collectors» y «Acquisition Units», con «Acquisition Units» seleccionada"]

. Para crear una nueva unidad de adquisición, haga clic en el botón de la derecha.
+
image:cloud-insights_image15.png["Una captura de pantalla que muestra el botón Add Acquisition Unit y un campo Filter"]
...
+
image:cloud-insights_image16.png["Una captura de pantalla que muestra las instrucciones de instalación de la unidad de adquisición de Cloud Insights para Linux y un fragmento del programa de instalación"]
...
+
image:cloud-insights_image17.png["Una ventana de terminal que muestra un comando de token para instalar la unidad de adquisición de Cloud Insights en Linux"]
...
+
image:cloud-insights_image18.png["Una terminal que muestra la instalación y el registro exitosos de la Acquisition Unit de Cloud Insights de NetApp"]
...
+
image:cloud-insights_image19.png["Una captura de pantalla del resumen de la unidad de adquisición NetApp-AU que muestra la IP, el estado OK y la última hora reportada"]
...
+
image:cloud-insights_image20.png["Una captura de pantalla que muestra las opciones filtradas del recopilador de datos ONTAP en la página Añadir recopilador de datos"]
...
+
image:cloud-insights_image21.png["Una captura de pantalla de la página Configure Collector con las credenciales de ONTAP validadas y la configuración de la Acquisition Unit"]
...
+
image:cloud-insights_image22.png["Una captura de pantalla de una fila del recopilador de datos de Cloud Insights que muestra el estado de sondeo de FlexPod Datacenter"]
