...
Esta solución de nube híbrida puede ampliarse a cualquier entorno de FlexPod que ejecute versiones compatibles de software, firmware y hardware, como se define en link:http://mysupport.netapp.com/matrix["Herramienta de matriz de interoperabilidad de NetApp"^], link:https://ucshcltool.cloudapps.cisco.com/public/["Compatibilidad de hardware y software de UCS"^] y link:https://www.vmware.com/resources/compatibility/search.php["Guía de compatibilidad de VMware"^].
