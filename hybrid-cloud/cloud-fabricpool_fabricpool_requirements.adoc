...
NOTE: Consulta el https://hwu.netapp.com/DetailViews/Home.aspx[] [NetApp Hardware Universe^] para obtener la información más reciente sobre las plataformas compatibles con FabricPool.

* NetApp ONTAP Select [NOTA] NetApp recomienda usar niveles locales all-SSD FabricPool.
* Niveles de cloud
+
