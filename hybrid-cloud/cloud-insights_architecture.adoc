...
image:cloud-insights_image2.png["Un diagrama que muestra Cisco UCS, conmutadores Nexus, controladores AFF A800 de NetApp y conmutadores MDS interconectados mediante enlaces de red"]
...
* Análisis del entorno con los datos facilitados a NetApp Digital Advisor para evaluar los riesgos del sistema de almacenamiento y recomendaciones para la optimización del almacenamiento.
