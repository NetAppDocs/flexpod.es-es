...
La siguiente figura ilustra el FlexPod Datacenter para FC con Cisco MDS.
...
Para obtener más información sobre la implementación de ONTAP, consulta https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["TR-4684: Implementación y configuración de San modernas con NVMe"^].
