...
NOTE: Consulta https://intersight.com/help/saas/supported_systems/overview["Sistemas compatibles con Cisco Intersight"^] para conocer los requisitos mínimos de los componentes de computación de Cisco UCS y la versión de UCSM.
...
Para obtener más información sobre las funciones incluidas en los distintos niveles de licencia, visita https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["Licencia de servicios de infraestructura"^].
