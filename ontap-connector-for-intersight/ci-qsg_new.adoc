...
NOTE: Se requiere una actualización a NetApp Active IQ Unified Manager 9.14RC1 para garantizar la compatibilidad y la funcionalidad completa con la última versión.
