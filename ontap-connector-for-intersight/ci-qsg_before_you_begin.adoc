...
. Descarga el dispositivo virtual Cisco Intersight en https://software.cisco.com/download/home/286319499/type/286323047/release/1.1.7-0.a["software.cisco.com"^]. Para obtener más información, visita https://www.cisco.com/c/en/us/td/docs/unified_computing/Intersight/b_Cisco_Intersight_Appliance_Getting_Started_Guide/b_Cisco_Intersight_Appliance_Install_and_Upgrade_Guide_chapter_00.html["Guía de instalación y actualización de Intersight Appliance"^].
...
+
.. Accede a `https://<FQDN-of-your-appliance>` para completar la configuración posterior a la instalación de tu dispositivo.
+
