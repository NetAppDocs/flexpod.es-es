...
image:flexpod-fips-image3.png["Un diagrama que muestra el flujo de datos cifrados en la escritura y descifrados en la lectura a través de la red, WAFL, RAID y almacenamiento con un módulo criptográfico"]
...
image:flexpod-fips-image4.png["Un diagrama que muestra el cifrado y el descifrado a través de las capas de Network, WAFL, RAID y el módulo criptográfico de Storage"]
...
image:flexpod-fips-image5.png["Un diagrama que muestra el ámbito criptográfico de ONTAP con los componentes key manager, cryptomod y cryptomod_fips"]
