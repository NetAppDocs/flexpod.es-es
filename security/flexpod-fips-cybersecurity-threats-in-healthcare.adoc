...
image:flexpod-fips-image2.png["Un diagrama que muestra la integración de aplicaciones empresariales que conecta los sistemas clínicos y administrativos de un hospital"]
