...
image:flexpod-fips-image6.png["Un diagrama que muestra FlexPod conforme con FIPS 140-2 para las conexiones de computación, redes y almacenamiento en el sector sanitario"]
