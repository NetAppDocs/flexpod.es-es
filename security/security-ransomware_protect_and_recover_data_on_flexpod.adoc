...
image:security-ransomware_image3.png["Una captura de pantalla de la carpeta «Documentos» de Windows en la que aparecen archivos PDF sin cifrar de WorkDoc"]

La siguiente captura de pantalla muestra el recurso compartido de CIFS asignado a la máquina virtual.

image:security-ransomware_image4.png["Una captura de pantalla en la que se ve la unidad de red CIFS fpolicy_share asignada como unidad Z: en el Explorador de archivos de Windows"]
...
image:security-ransomware_image5.png["Una captura de pantalla del Explorador de archivos en la que se muestran los archivos sin cifrar del recurso compartido CIFS fpolicy_share, asignado como unidad Z"]
...
image:security-ransomware_image6.png["Una captura de pantalla de la eficiencia de almacenamiento de «infra_datastore1» que muestra un ahorro por deduplicación de 5,84 GB (19 %)"]

Se obtuvo un ahorro del 45% gracias a la deduplicación en la unidad CIFS `fpolicy_share`.

image:security-ransomware_image7.png["Una captura de pantalla de la eficiencia de almacenamiento de cifS_volume que muestra un ahorro por deduplicación de 5,05 GB (45 %)"]

Se observó un tamaño de copia snapshot de 456 KB para el volumen donde se alojaba el equipo virtual.

image:security-ransomware_image8.png["Una captura de pantalla de las Snapshot Copies de infra_datastore1 que muestran before_attack, con un tamaño total de 456 KB"]

Se observó un tamaño de copia Snapshot de 160 KB para el recurso compartido de CIFS `fpolicy_share`.

image:security-ransomware_image9.png["Una captura de pantalla de la pestaña Snapshot Copies de cifS_volume que muestra la snapshot before_attack_cifs con un tamaño total de 160 KB"]
...
+
image:security-ransomware_image10.png["Un icono de una carpeta comprimida llamada Ransomware.WannaCry"]

. Se ejecutó el binario.
+
image:security-ransomware_image11.png["Una captura de pantalla del Explorador de archivos de Windows que muestra un ejecutable de WannaCry seleccionado con la opción de menú Ejecutar como administrador"]
...
image:security-ransomware_image12.png["Una captura de pantalla del Explorador de archivos de Windows que muestra archivos PDF y archivos WNCRY cifrados en Documentos"]

El malware cifra todos los archivos del equipo virtual local y del recurso compartido asignado.

image:security-ransomware_image13.png["Una captura de pantalla que muestra archivos compartidos CIFS locales y asignados cifrados con extensiones WNCRY"]
...
image:security-ransomware_image14.png["Una captura de pantalla que muestra la pestaña Copias de Snapshot de cifs_volume, con un tamaño de Snapshot de 820,98 MB"]
...
image:security-ransomware_image15.png["Una captura de pantalla de la pestaña Copias de instantánea de infra_datastore1 que muestra una copia de instantánea before_attack de 404,3 MB"]

La eficiencia de almacenamiento para el volumen que aloja la unidad CIFS se redujo a un 34 %.

image:security-ransomware_image16.png["Una captura de pantalla de la eficiencia de almacenamiento de cifsv_volume que muestra un ahorro total de 5 GB al 34 %"]
...
+
image:security-ransomware_image17.png["Una captura de pantalla del menú de acciones de vSphere para WannaCry-2016-1 con NetApp SnapCenter Restore seleccionado"]

. Seleccione la copia de Snapshot coherente con VMware que desee restaurar.
+
image:security-ransomware_image18.png["Una captura de pantalla del asistente de restauración en la que se muestran las copias de seguridad de instantáneas de VMware disponibles, con una de ellas seleccionada"]

. Toda la máquina virtual se restaura y se reinicia.
+
image:security-ransomware_image19.png["Un asistente de restauración que selecciona toda la máquina virtual WannaCry-2016-1 y la reinicia en un host ESXi"]

. Haga clic en Finalizar para iniciar el proceso de restauración.
+
image:security-ransomware_image20.png["Resumen del asistente de restauración para la máquina virtual WannaCry-2016-1 con un botón Finalizar y una advertencia de apagado"]

. Se restauran el equipo virtual y sus archivos.
+
image:security-ransomware_image21.png["Una captura de pantalla del Explorador de archivos de Windows que muestra los archivos PDF restaurados en la carpeta Documents"]
...
+
image:security-ransomware_image22.png["Una captura de pantalla que muestra la pestaña «Copias de Snapshot» de cifs_volume con la acción «Restaurar» seleccionada"]

. Haga clic en OK para iniciar la operación de restauración.
+
image:security-ransomware_image23.png["Un cuadro de diálogo de confirmación de «Restaurar volumen» con los botones «Aceptar» y «Cancelar» para restaurar cif_volume desde una copia Snapshot"]

. Vea el recurso compartido CIFS después de la restauración.
+
image:security-ransomware_image24.png["Una captura de pantalla del Explorador de archivos de Windows que muestra la unidad CIFS asignada fpolicy_share con carpetas, imágenes de disco y archivos PDF"]
...
image:security-ransomware_image25.png["Una captura de pantalla que muestra archivos PDF sin cifrar de WorkDoc en Documentos y en la unidad fpolicy_share"]
...
image:security-ransomware_image26.png["Una captura de pantalla de archivos de máquina virtual cifrados junto a archivos PDF no afectados en un recurso compartido CIFS de FPolicy"]
