...
image:medical-imaging_image8.png["Un diagrama que muestra los nodos AFF A300 con a0a ifgrps, VLANs y LIFs de NFS e iSCSI"]
...
* Usa la tecnología de replicación basada en matrices de almacenamiento de NetApp llamada  https://www.netapp.com/pdf.html?item=/media/17229-tr4015.pdf["SnapMirror"^] en lugar de la replicación basada en vSphere.
