...
+
image:flexpod-genomics-image18.png["Una captura de pantalla de la pestaña «GPUs» del inventario de Cisco UCS Manager mostrando una tarjeta gráfica P6 en modo Compute"]

+
image:flexpod-genomics-image19.png["Una captura de pantalla de Cisco UCS Manager en la que se muestra el inventario de GPU con una UCSB-GPU-P6-R en modo Compute"]
...
. Este comando instala el  https://docs.nvidia.com/vgpu/latest/grid-software-quick-start-guide/installing-configuring-vgpu-manager-guest-driver.html#installing-the-nvidia-virtual-gpu-manager-on-vmware-vsphere["Administrador vGPU de NVIDIA"^] en ESXi.
+
....
...
+
image:flexpod-genomics-image20.png["Una captura de pantalla de vSphere Client que muestra el dispositivo gráfico NVIDIA Tesla P6 configurado para Shared Direct"]

+
image:flexpod-genomics-image21.png["Una captura de pantalla de «Editar configuración del dispositivo gráfico» con la opción «Directo compartido» seleccionada y la casilla «Reiniciar el servidor X.Org» marcada"]
...
+
image:flexpod-genomics-image22.png["Una captura de pantalla de las opciones de arranque de una máquina virtual vCenter mostrando el firmware EFI y el arranque seguro desactivados"]
...
+
image:flexpod-genomics-image23.png["Una captura de pantalla que muestra la sección Avanzado de Edit Settings de vCenter con un enlace Edit Configuration"]

+
image:flexpod-genomics-image24.png["Una captura de pantalla del cuadro de diálogo de Parámetros de configuración que muestra los valores de pciPassthru.64bitMMIOSizeGB y pciPassthru.use64bitMMIO"]
...
+
image:flexpod-genomics-image25.png["Una captura de pantalla de vCenter Edit Settings que muestra el perfil de vGPU de NVIDIA GRID grid_p6-16c seleccionado para un dispositivo PCI"]
...
+
image:flexpod-genomics-image26.png["Una captura de pantalla de la página «Clientes con licencia» del servidor de licencias de NVIDIA, en la que aparece un cliente Ethernet virtual"]
