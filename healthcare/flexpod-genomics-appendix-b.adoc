...
summary: En esta sección se describe la ejecución de la salida ./gatk. 
---
...
link:flexpod-genomics-appendix-a.html["Anterior: Salida para la ejecución de GATK usando el archivo JAR."]
...
link:flexpod-genomics-appendix-c.html["Siguiente: Salida para la ejecución de GATK con el motor Cromwell."]
