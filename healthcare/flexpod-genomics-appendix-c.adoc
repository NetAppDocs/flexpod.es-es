...
summary: Esta sección muestra la salida después de ejecutar el GATK utilizando el motor Cromwell. 
---
...
....
link:flexpod-genomics-appendix-d-gpu-setup.html["Siguiente: Configuración de GPU."]
