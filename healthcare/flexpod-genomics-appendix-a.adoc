...
summary: En esta sección se proporciona la salida del archivo JAR de GATK. 
---
...
link:flexpod-genomics-genomics---gatk-setup-and-execution.html["Anterior: Genómica - instalación y ejecución de GATK."]
