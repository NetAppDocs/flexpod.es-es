...
La asistencia sanitaria tal y como la conocemos gira en torno a los profesionales sanitarios (médicos, enfermeros, radiólogos, técnicos de dispositivos médicos, etc.) y a los pacientes. A medida que acercamos a pacientes y profesionales sanitarios, convirtiendo la ubicación geográfica en un mero dato más, cobra aún más importancia que la plataforma subyacente esté disponible cuando los profesionales y los pacientes la necesiten. La plataforma debe ser eficiente y rentable a largo plazo. En su esfuerzo por reducir aún más los costes de la atención al paciente,  https://www.cms.gov/priorities-innovation-key-concepts-accountable-care-accountable-care-organizations["Organizaciones de atención responsable"^] (ACOs) se verían reforzadas por una plataforma eficiente.
...
* Las modalidades móviles, como los dispositivos de escaneo inalámbricos y portátiles (por ejemplo, ecógrafos de bolsillo conectados a un teléfono), requieren una infraestructura de red robusta con seguridad, fiabilidad y latencia al nivel del Departamento de Defensa (DoD) tanto en el perímetro, el núcleo y en la nube. https://www.netapp.com/blog/medical-imaging-cloud-disaster-recovery-meets-ai/["Una estructura de datos habilitada por NetApp"^] proporciona a las organizaciones esta capacidad a gran escala.
* Las nuevas técnicas médicas tienen unos requisitos de almacenamiento exponenciales; por ejemplo, la tomografía computarizada (CT) y la resonancia magnética (MRI) requieren unos cientos de MB por cada técnica, pero las imágenes de patología digital (incluidas las imágenes de portaobjetos completos) pueden alcanzar un tamaño de varios GB. FlexPod está diseñado con https://www.netapp.com/pdf.html?item=/media/16926-sb-flexpod-advantage-performance-agility-economics.pdf["rendimiento, fiabilidad y escalabilidad como rasgos fundamentales"^].
...
image:medical-imaging_image2.png["Un diagrama que muestra el modelo de soporte conjunto FlexPod entre los clientes, Cisco y NetApp"]
