...
image:medical-imaging_image3.png["Un diagrama que muestra la infraestructura de imágenes médicas FlexPod con UCS, Nexus, AFF y conmutadores MDS"]
...
Se puede encontrar más información https://www.netapp.com/pdf.html?item=/media/8327-ds-3820.pdf["aquí"^] .
...
image:medical-imaging_image4.png["Un diagrama que muestra los servidores SnapCenter, la integración con VMware, los repositorios de metadatos replicados y los complementos de aplicaciones"]

NetApp MetroCluster se utiliza por miles de empresas en todo el mundo para alta disponibilidad (HA), cero pérdida de datos y operaciones sin interrupciones tanto dentro como fuera del centro de datos. MetroCluster es una función gratuita del software ONTAP que duplica de forma sincrónica los datos y la configuración entre dos clústeres ONTAP en ubicaciones o dominios de fallo separados. MetroCluster proporciona almacenamiento disponible de forma continua para las aplicaciones al gestionar automáticamente dos objetivos: cero objetivo de punto de recuperación (RPO) mediante la duplicación sincrónica de los datos escritos en el clúster. Objetivo de tiempo de recuperación (RTO) cercano a cero mediante la duplicación de la configuración y la automatización del acceso a los datos en el segundo sitio. MetroCluster ofrece simplicidad con la duplicación automática de datos y configuración entre los dos clústeres independientes ubicados en los dos sitios. A medida que se aprovisiona almacenamiento dentro de un clúster, se duplica automáticamente en el segundo clúster en el segundo sitio. NetApp SyncMirror proporciona una copia completa de todos los datos con un RPO de cero. Por lo tanto, las cargas de trabajo de un sitio pueden cambiarse en cualquier momento al sitio opuesto y seguir sirviendo datos sin pérdida de datos. Puedes encontrar más información https://fieldportal.netapp.com/s/article/tr4705-netapp-metrocluster-solution-architecture-and-design-1693982882873["aquí"^].
...
image:medical-imaging_image5.png["Un diagrama que muestra una clínica comunitaria conectada a los sistemas hospitalarios a través de un bus de servicios empresariales"]
...
Los radiólogos suelen utilizar visores de diagnósticos de gama alta habilitados para gráficos que se ejecutan en estaciones de trabajo gráficas e informáticas de gama alta que son físicas o parte de una infraestructura de escritorios virtuales. Si está a punto de iniciar su viaje hacia la infraestructura de puestos de trabajo virtuales, encontrará más información https://www.netapp.com/pdf.html?item=/media/19872-tr-4190.pdf["aquí"^].
...
Los sistemas de imágenes médicas están empezando a usar  https://www.netapp.com/pdf.html?item=/media/7398-sb-flexpod-datacenter-ai.pdf["Funcionalidades de computación basadas en GPU"^] para optimizar los flujos de trabajo humanos mediante el preprocesamiento de las imágenes y así mejorar la eficiencia. Los sistemas de imágenes médicas empresariales típicos aprovechan las capacidades de eficiencia de almacenamiento líderes en la industria de NetApp. Los sistemas de imágenes médicas empresariales suelen usar RMAN para las actividades de copia de seguridad, recuperación y restauración. Para un mejor rendimiento y para reducir el tiempo que lleva crear copias de seguridad, la tecnología Snapshot está disponible para las operaciones de copia de seguridad y la tecnología SnapMirror está disponible para la replicación.

En la siguiente figura se muestran los componentes lógicos de la aplicación en una vista arquitectónica por capas.

image:medical-imaging_image6.png["Un diagrama que muestra los componentes de imágenes médicas organizados en capas en FlexPod con recuperación ante desastres replicada"]

La siguiente figura muestra los componentes físicos de la aplicación.

image:medical-imaging_image7.png["Un diagrama que muestra los centros de datos activos y en espera de FlexPod con almacenamiento ONTAP de NetApp y servidores de imágenes médicas"]
