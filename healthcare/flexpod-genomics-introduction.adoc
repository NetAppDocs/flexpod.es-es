...
image:flexpod-genomics-image2.png["Un diagrama que muestra las aplicaciones hospitalarias unificadas en FlexPod con protocolos, almacenamiento y conectividad en la nube"]
