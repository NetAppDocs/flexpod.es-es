...
image:flexpod-genomics-image6.png["Un diagrama que muestra FlexPod para genómica con Cisco UCS, Nexus, MDS y conectividad AFF A700 de NetApp"]

En el siguiente diagrama se describen los detalles del cableado FlexPod.

image:flexpod-genomics-image7.png["Un diagrama que muestra FlexPod para Genomics del cableado entre UCS, Nexus, NetApp AFF y los switches MDS"]
