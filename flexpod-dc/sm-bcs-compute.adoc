...
image:sm-bcs-image17.png["Un esquema que muestra los UCS 2204XP A y B conectados a un B200 M5 VIC a través de 10GBASE-KR"]
...
image:sm-bcs-image18.png["Un diagrama que muestra los IOM UCS 5108 conectados a los switches FI 6454 y a los switches Nexus A y B"]
...
image:sm-bcs-image19.png["Una captura de pantalla que muestra el cuadro de diálogo Set iSCSI Boot Parameters de Cisco UCS Manager con dos destinos estáticos configurados"]
