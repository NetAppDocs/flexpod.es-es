...
image:sm-bcs-image2.png["Un diagrama que muestra los componentes de FlexPod Datacenter: Cisco UCS, switches Nexus/MDS y almacenamiento NetApp AFF/FAS/ASA"]
...
image:sm-bcs-image3.png["Un diagrama que muestra la replicación síncrona SnapMirror y la conmutación automática al respaldo entre los centros de datos primario y secundario"]
