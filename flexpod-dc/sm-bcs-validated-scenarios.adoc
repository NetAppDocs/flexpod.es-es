...
image:sm-bcs-image47.png["Un diagrama que muestra las rutas iSCSI de ESXi a través de dos estructuras de red hacia los LUN del grupo de consistencia primario y de destino"]
...
image:sm-bcs-image48.png["Una captura de pantalla de la pestaña «Rutas de los adaptadores de almacenamiento» de ESXi mostrando dos rutas activas (E/S) y seis rutas iSCSI activas"]
...
image:sm-bcs-image49.png["Una captura de pantalla del vSphere Client que muestra seis almacenes de datos iSCSI montados en el host esxi-a-01.nva.local"]
...
image:sm-bcs-image50.png["Una captura de pantalla de la selección de almacenamiento de migración de vSphere para iometer-a-01 con almacenes de datos iSCSI de los sitios A y B"]
...
+
image:sm-bcs-image51.png["Una captura de pantalla de Relaciones en ONTAP System Manager con el menú de opciones de origen mostrando Conmutación automática al respaldo"]

. Confirme la conmutación por error para el inicio de la acción.
+
image:sm-bcs-image52.png["Captura de pantalla de la confirmación de la conmutación por error planificada en ONTAP System Manager para cg_esxi_a de Infra-SVM.1 a Infra-SVM-b"]
...
image:sm-bcs-image53.png["Una captura de pantalla de ONTAP System Manager que muestra los gráficos de rendimiento del sitio A con IOPS y rendimiento reducidos"]
...
image:sm-bcs-image54.png["Una captura de pantalla del panel de control de ONTAP System Manager que muestra un rendimiento de 132,99 K IOPS y un ancho de banda de 1.038,58 MB/s"]
...
image:sm-bcs-image55.png["Una captura de pantalla de ONTAP System Manager Relationships que muestra grupos de consistencia en buen estado y sincronizados, y una opción de menú de conmutación automática al respaldo"]
...
image:sm-bcs-image56.png["Diagrama que muestra que el almacenamiento del sitio A no está disponible y que los servicios de datos SM-BC continúan en el sitio B a través de ONTAP Mediator"]
...
image:sm-bcs-image57.png["Una captura de pantalla del panel de control de ONTAP System Manager en la que se muestran 80,32 mil IOPS y un rendimiento de 626,98 MB/s"]

image:sm-bcs-image58.png["Una captura de pantalla del panel de control de ONTAP System Manager para aff-a250-b que muestra 81,37 mil IOPS y un rendimiento de 635,41 MB/s"]
...
image:sm-bcs-image59.png["Captura de pantalla de ONTAP System Manager que muestra un aumento notable en el rendimiento de IOPS y el rendimiento de transferencia en el clúster aff-a250-b"]
...
image:sm-bcs-image60.png["Una captura de pantalla de las relaciones de ONTAP System Manager en la que se muestran dos relaciones en buen estado que no están sincronizadas"]
...
image:sm-bcs-image61.png["Una captura de pantalla que muestra las relaciones en ONTAP System Manager con estado saludable y sincronizado"]
...
image:sm-bcs-image62.png["Una captura de pantalla del cuadro de diálogo «Editar regla de máquina virtual/host» en la que se asignan las máquinas virtuales del sitio A al grupo de hosts del sitio B"]
...
image:sm-bcs-image63.png["Una captura de pantalla de dos ventanas de la CLI de BMC en las que se muestran los comandos de apagado del sistema para aff-a250-a-01 y aff-a250-a-02"]
...
image:sm-bcs-image64.png["Una captura de pantalla de un panel de Grafana que muestra las métricas de latencia, rendimiento e IOPS de SVM para Infra-SVM en el clúster AFF A250-a"]

image:sm-bcs-image65.png["Una captura de pantalla del panel de control de Grafana SVM que muestra los gráficos de latencia, rendimiento e IOPS de Infra-SVM-b"]
...
image:sm-bcs-image66.png["Captura de pantalla de las opciones de compilación de TPROC-C de Microsoft SQL Server con 100 almacenes y 10 usuarios virtuales"]
...
image:sm-bcs-image67.png["Una captura de pantalla del contador de transacciones de HammerDB en la que se aprecia una breve caída y recuperación de las transacciones durante la creación de TPROC-C"]
...
image:sm-bcs-image68.png["Una captura de pantalla del panel de control de Grafana de NAbox que muestra cómo las métricas de latencia, rendimiento e IOPS del clúster de almacenamiento del sitio B caen a cero"]
...
image:sm-bcs-image69.png["Una captura de pantalla del panel de control de Grafana de NAbox que muestra las métricas de latencia, rendimiento e IOPS del SVM del sitio A"]
