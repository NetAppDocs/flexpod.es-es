...
image:sm-bcs-image16.png["Un diagrama que muestra los sitios A y B de FlexPod conectados mediante relaciones extendidas de Capa 2 y SM-BC con ONTAP Mediator en el sitio C"]
