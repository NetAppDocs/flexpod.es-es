...
image:sm-bcs-image22.png["Un diagrama que muestra un AFF A250 conectado a los switches Nexus A y Nexus B en dos sitios"]
...
image:sm-bcs-image23.png["Un diagrama que muestra los puertos del controlador AFF A250 conectados a Nexus, los grupos de interfaces, los puertos VLAN y los LIF"]
...
image:sm-bcs-image24.png["Un diagrama que muestra la conectividad de arranque SAN iSCSI redundante desde servidores B200 M5 a controladores AFF A250"]
...
image:sm-bcs-image25.png["Una captura de pantalla del cuadro de diálogo Add Intercluster Interfaces de ONTAP System Manager con dos campos de dirección IP"]
...
+
image:sm-bcs-image26.png["Una captura de pantalla del cuadro de diálogo «Generar frase de contraseña» con los permisos del clúster de iguales, la validez y una frase de contraseña copiada"]
...
+
image:sm-bcs-image27.png["Una captura de pantalla que muestra el cuadro de diálogo clúster de iguales de ONTAP System Manager con la frase de contraseña y las direcciones LIF entre clústeres"]

. El panel Protección de System Manager > Overview muestra la información de paridad entre clústeres.
+
image:sm-bcs-image28.png["Una captura de pantalla de la vista general de protección de ONTAP System Manager que muestra el estado del clúster de iguales y del mediador"]
...
image:sm-bcs-image29.png["Una captura de pantalla del cuadro de diálogo Configurar mediador de ONTAP System Manager con los campos de conexión del mediador"]
...
image:sm-bcs-image30.png["Una captura de pantalla del panel «Resumen de protección» de ONTAP System Manager en la que se muestra el estado del Mediator configurado"]
...
image:sm-bcs-image31.png["Una captura de pantalla del cuadro de diálogo Protect Consistency Group con el volumen de origen esxi_a y el clúster de destino aff-a250-b"]
...
image:sm-bcs-image32.png["Una captura de pantalla de las relaciones de ONTAP System Manager en la que se muestran dos grupos de consistencia en buen estado y sincronizados en el sitio A"]

Esta captura de pantalla muestra las relaciones de los grupos de consistencia en la instalación B.

image:sm-bcs-image33.png["Una captura de pantalla de las relaciones de ONTAP System Manager en el sitio B que muestra dos grupos de consistencia en buen estado y sincronizados"]
...
image:sm-bcs-image34.png["Una captura de pantalla de ONTAP System Manager en la que se muestran los detalles de la relación del grupo de consistencia «cg_infra_datastore_b»"]
...
image:sm-bcs-image35.png["Una captura de pantalla de la información de los volúmenes ONTAP de Infra-SVM-a, incluidos los volúmenes RW, DP y LS"]

Esta captura de pantalla muestra la información de volumen del sitio B.

image:sm-bcs-image36.png["Una captura de pantalla de la salida de «ONTAP volume show» para Infra-SVM-b, en la que aparecen nueve volúmenes, incluidos los volúmenes de destino DP"]
...
image:sm-bcs-image37.png["Una captura de pantalla que muestra los igroups iSCSI y las asignaciones de LUN del sitio A en la salida de la CLI de ONTAP"]

Esta captura de pantalla muestra los iGroups del host y la asignación de LUN para el clúster del sitio B.

image:sm-bcs-image38.png["Una captura de pantalla del sitio B igroup y el resultado del comando de asignación de LUN para hosts VMware iSCSI"]
