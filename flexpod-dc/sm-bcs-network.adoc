...
image:sm-bcs-image20.png["Un diagrama que muestra FI 6454, Nexus y AFF A250 con conectividad local redundante"]
...
image:sm-bcs-image21.png["Un diagrama que muestra los enlaces entre pares de vPC y los enlaces entre sedes de los switches FlexPod en los sitios A y B"]
